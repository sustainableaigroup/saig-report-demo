...
#place(top + left, dx: 0.58in, dy: 3.3in)[
  #text(font: "DM Mono", size: 16pt, tracking: 0.8pt, fill: rgb("#242424"))[[Closed-model Latent Energy Estimation Range]]
]
...
#place(top + left, dx: 0.58in, dy: 6.6in)[
  #block(width: 6.90in)[
    #set par(leading: 0.72em)
