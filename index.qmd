...
#place(top + left, dx: 0.52in, dy: 0.66in)[
  #block(width: 2.85in, height: 0.78in, fill: white, radius: 10pt, inset: 10pt)[
    #image("assets/saig-logo.png", width: 2.28in)
  ]
]

#place(top + left, dx: 0.58in, dy: 2.20in)[
  #text(font: "DM Mono", size: 7.5pt, tracking: 0.8pt, fill: white)[TECHNICAL REPORT / DEMONSTRATION]
]

#place(top + left, dx: 0.58in, dy: 3.03in)[
  #text(font: "Inter", size: 36pt, weight: "medium", fill: white)[AI Environmental]
]
#place(top + left, dx: 0.58in, dy: 3.66in)[
  #text(font: "Inter", size: 36pt, weight: "medium", fill: white)[Impact Assessment]
]

#place(top + left, dx: 0.58in, dy: 4.48in)[
  #block(width: 6.90in)[
    #set par(leading: 0.72em)
    #text(font: "DM Sans", size: 13pt, fill: rgb("#F4F8F8"))[
      A boilerplate report showing how SAIG can combine a polished web experience, hoverable references, technical graphics, and a one-click Typst PDF from the same Quarto source.
    ]
  ]
]
...
#place(top + left, dx: 0.58in, dy: 9.20in)[
  #block(width: 7.34in, height: 0.98in, fill: white, radius: 11pt, inset: 14pt)[
    #grid(
      columns: (1fr, 1fr, 1fr),
      gutter: 14pt,
      [#text(font: "DM Mono", size: 6.5pt, fill: rgb("#4F747D"))[CLIENT]],
      [#text(font: "DM Mono", size: 6.5pt, fill: rgb("#4F747D"))[VERSION]],
      [#text(font: "DM Mono", size: 6.5pt, fill: rgb("#4F747D"))[DATE]],
    )
    #v(5pt)
    #grid(
      columns: (1fr, 1fr, 1fr),
      gutter: 14pt,
      [#text(font: "DM Sans", size: 10.5pt, weight: "medium", fill: rgb("#033845"))[DEMONSTRATION]],
      [#text(font: "DM Sans", size: 10.5pt, weight: "medium", fill: rgb("#033845"))[0.1]],
      [#text(font: "DM Sans", size: 10.5pt, weight: "medium", fill: rgb("#033845"))[31 AUGUST 2026]],
    )
  ]
]
...
#show heading.where(level: 1): it => block(above: 10pt, below: 14pt)[
  #text(font: "Inter", size: 25pt, weight: "medium", fill: rgb("#B8663B"))[#it.body]
]
#show heading.where(level: 2): it => block(above: 12pt, below: 8pt)[
