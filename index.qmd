...
#place(top + left, dx: 0.58in, dy: 9.20in)[
  #block(width: 7.34in, height: 0.98in, fill: white, radius: 11pt, inset: 14pt)[
    ...
    #grid(
      columns: (1fr, 1fr, 1fr),
      gutter: 14pt,
      [#text(font: "DM Mono", size: 9.2pt, weight: "medium", fill: rgb("#033845"))[DEMONSTRATION]],
      [#text(font: "DM Mono", size: 9.2pt, weight: "medium", fill: rgb("#033845"))[0.1]],
      [#text(font: "DM Mono", size: 9.2pt, weight: "medium", fill: rgb("#033845"))[31 AUGUST 2026]],
    )
  ]
]
