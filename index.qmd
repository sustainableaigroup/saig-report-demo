...
#place(top + left, dx: 0.58in, dy: 3.9in)[
  #text(font: "DM Mono", size: 16pt, tracking: 0.8pt, fill: rgb("#B8663B"))[[Closed-model Latent Energy Estimation Range]]
]

#place(top + left, dx: 0.58in, dy: 5in)[
  #block(width: 6.90in)[
...
#place(top + left, dx: 0.58in, dy: 8in)[
  #block(width: 6.90in)[
    #set par(leading: 0.72em)
