...
#place(top + left, dx: 0.58in, dy: 2.20in)[
  #text(font: "DM Mono", size: 7.5pt, tracking: 0.8pt, fill: rgb("#242424"))[TECHNICAL REPORT]
]

#place(top + left, dx: 0.58in, dy: 3.03in)[
  #text(font: "Inter", size: 36pt, weight: "medium", fill: rgb("#242424"))[CLEER]
]
#place(top + left, dx: 0.58in, dy: 3.66in)[
  #text(font: "Inter", size: 36pt, weight: "medium", fill: rgb("#242424"))[Technical Report]
]

#place(top + left, dx: 0.58in, dy: 4.48in)[
  #block(width: 6.90in)[
    #set par(leading: 0.72em)
    #text(font: "Source Serif 4", size: 13.2pt, fill: rgb("#242424"))[
